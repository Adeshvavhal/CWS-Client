...
function MyProfile({ user }) {
  ...
  const handleRemoveImage = async (e) => {
    ...
    try {
      ...
      const res = await axios.delete(
        `https://cws-server.vercel.app/employees/${user._id}/image`
      );
  ...
  useEffect(() => {
    ...
    const fetchProfile = async () => {
      try {
        const res = await axios.get(`https://cws-server.vercel.app/employees/${user._id}`);
        setProfile(res.data);
        setFormData({
          ...res.data,
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await axios.put(`https://cws-server.vercel.app/employees/${user._id}`, data, {
      ...
      // Refresh profile
      const updated = await axios.get(`https://cws-server.vercel.app/employees/${user._id}`);
